...
export default function AtlasChat() {
  const [messages, setMessages] = useState<Message[]>([{
    id: '1',
    content: "I'm Atlas, your Chief EVE™ Orchestrator. I monitor all operations and coordinate with other EVEs™. How can I assist you today?",
    sender: 'atlas',
    timestamp: new Date()
  }]);
    ...
    try {
      ...
      await chat(input, (chunk) => {
        ...
        setMessages(prev => {
          ...
          if (lastMessage?.sender === 'atlas' && lastMessage.id === 'streaming') {
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-white/10">
        <div className="flex items-center">
          ...
          <div>
            <h3 className="text-white font-medium">Atlas</h3>
            <p className="text-xs text-gray-400">Chief EVE™ Orchestrator</p>
          </div>
        </div>
